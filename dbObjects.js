...
//const Team = require('./unneeded/Team.js')(sequelize, Sequelize.DataTypes);
//const Player = require('./unneeded/Player.js')(sequelize, Sequelize.DataTypes);
...
module.exports = { Tipper, Tip , Match, Static};